...
opcoes.add_left_right_image_flips = True # Este primeiro comando serve para mudar o angulo das imagens de aprendizado
                                         # automaticamente
opcoes.C = 5 # Este parâmetro é o "custo" do algoritmo. Quanto maior o número melhor o resultado. Porém será menos eficaz
             # em prever novos padrões


#Por fim, aqui eu passo o xml com as posições das imagens e ele irá me retornar o algoritmo pronto
dlib.train_simple_object_detector("fotos/treinamentoS/treinamentoSmascara.xml", "fotos/treinamentoS/semmascara.svm", opcoes)
